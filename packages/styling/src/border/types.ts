 ...
 */
export const BorderCharsSchema = z.object({
  top: z.string()
 ...
 */
export const BorderSidesSchema = z.tuple([
 ...
 */
export const CustomBorderConfigSchema = z.object({
  chars: BorderCharsSchema.partial()
    .describe('Partial character set - missing characters will use defaults from normal border'),
  sides: BorderSidesSchema
    .optional()
    .describe('Optional visibility settings - defaults to all sides visible if not specified'),
