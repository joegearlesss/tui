 ...
 */
export const ListConfigSchema: z.ZodType<ListConfig> = z.object({
  items: z
    .array(ListItemSchema)
    .min(0, 'List can be empty')
    .describe('Array of list items, can be strings or nested list configurations'),
  
  enumerator: EnumeratorFunctionSchema
    .optional()
    .describe('Function to generate bullet points or numbering. Defaults to bullet points'),
 ...
 */
export const ListMetricsSchema: z.ZodType<ListMetrics> = z.object({
  totalItems: z
    .number()
    .int()
    .min(0)
    .describe('Total number of items including nested items'),
  
  maxDepth: z
    .number()
    .int()
    .min(0)
    .describe('Maximum nesting depth of the list'),
 ...
 */
export const ListRenderOptionsSchema: z.ZodType<ListRenderOptions> = z.object({
  includeAnsi: z
    .boolean()
    .optional()
